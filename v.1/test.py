...
"}")
        ...
        self.layoutWidget.setGeometry(QtCore.QRect(110, 90, 275, 31))
        ...
        self.label_4.setGeometry(QtCore.QRect(110, 60, 55, 16))
        font = QtGui.QFont()
        font.setFamily("Snap ITC")
...
class MainFuncWindow(QWidget):
    ...
    def on_open(self):
        ...
        if ports == []:
                self.ui.point_label.setText("Прибор не подключен!")
        else:
                port = ports[0]
